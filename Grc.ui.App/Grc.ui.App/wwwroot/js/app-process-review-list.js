        ...
        columns: [
            {
                ...
                headerSort: true,
                frozen: true,
                formatter: (cell) => `<span class="clickable-title" onclick="viewReviewRecord(${cell.getRow().getData().id})">${cell.getValue()}</span>`
            },
            ...
            { title: "PROCESS MANAGER", field: "assigneeName", minWidth: 400 },
            {
                ...
                formatter: function (cell) {
                    ...
                    return `<button class="grc-table-btn grc-btn-view grc-view-action" onclick="viewReviewStatus(${rowData.id})">
...
function viewReviewRecord(id) {
    alert("View review record: " + id);
}

function viewReviewStatus(id) {
    alert("View review status: " + id);
}
