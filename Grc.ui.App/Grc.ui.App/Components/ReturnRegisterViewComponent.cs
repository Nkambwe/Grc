...
namespace Grc.ui.App.Components {
    ...
    public class ReturnRegisterViewComponent : ViewComponent {

        private readonly IDashboardFactory _dDashboardFactory;
        private readonly IWebHelper _webHelper;
        private readonly IAuthenticationService _authService;

        public ReturnRegisterViewComponent(IDashboardFactory dDashboardFactory, IWebHelper webHelper, IAuthenticationService authService) {
