...
namespace Grc.ui.App.Components {
    public class UraCircularsViewComponent : ViewComponent {
        private readonly IDashboardFactory _dashboardFactory;
        private readonly IWebHelper _webHelper;
        private readonly IAuthenticationService _authService;

        public UraCircularsViewComponent(IDashboardFactory dashboardFactory, IWebHelper webHelper, IAuthenticationService authService) {
