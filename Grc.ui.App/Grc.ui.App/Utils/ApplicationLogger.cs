...
namespace Grc.ui.App.Utils {
    ...
    public class ApplicationLogger : IApplicationLogger {
        ...
        public ApplicationLogger(IEnvironmentProvider environement, IOptions<LoggingOptions> loggingOptions, string name) {
        ...
        public void LogActivity(string message, string type = "MSG") {
            ...
            try {
                ...
                Console.WriteLine($"ENVIROMENT IsLive={_environement.IsLive}, Log Path: {filepath}");
