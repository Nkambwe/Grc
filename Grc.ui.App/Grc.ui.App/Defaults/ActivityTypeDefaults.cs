namespace Grc.ui.App.Defaults{
    ...
    public class ActivityTypeDefaults {
        ...
        public const string COMPLIANCE_RETRIEVE_AUDIT = "Audits.Delete.Audit";
        public const string COMPLIANCE_RETRIEVE_REPORT = "Audits.Report.Retrieve";
        public const string COMPLIANCE_CREATE_REPORT = "Audits.Create.Report";
        public const string COMPLIANCE_EDITED_REPORT = "Audits.Edit.Report";
        public const string COMPLIANCE_DELETED_REPORT = "Audits.Delete.Report";
        public const string COMPLIANCE_RETRIEVE_AUDIT_TYPE = "Audits.Type.Retrieve";
        ...
        public const string COMPLIANCE_DELETED_AUDIT_TYPE = "Audits.Delete.Audit.Type";
        public const string COMPLIANCE_RETRIEVE_AUDIT_TASK = "Audits.Tasks.Retrieve";
        public const string COMPLIANCE_CREATE_AUDIT_TASK = "Audits.Create.Tasks";
        public const string COMPLIANCE_EDITED_AUDIT_TASK = "Audits.Edit.Tasks";
        public const string COMPLIANCE_DELETED_AUDIT_TASK = "Audits.Delete.Tasks";
