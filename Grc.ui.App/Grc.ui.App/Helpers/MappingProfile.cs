    ...
    public class MappingProfile: Profile {
        ...
        public MappingProfile() { 
            ...
            CreateMap<PolicyViewModel, GrcPolicyDocumentRequest>()
                ...
                .ForMember(dest => dest.NeedBoardApproval, opt => opt.MapFrom(src => src.NeedBoardApproval))
                .ForMember(dest => dest.NeedMcrApproval, opt => opt.MapFrom(src => src.NeedMcrApproval))
                .ForMember(dest => dest.OnIntranet, opt => opt.MapFrom(src => src.OnIntranet))
                .ForMember(dest => dest.IsDeleted, opt => opt.MapFrom(src => src.IsDeleted))
                .ForMember(dest => dest.IsLocked, opt => opt.MapFrom(src => src.IsLocked))
                .ForMember(dest => dest.IsApproved, opt => opt.MapFrom(src => src.IsApproved == 2))
