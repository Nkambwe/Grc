...
namespace Grc.ui.App.Helpers {
    ...
    public class GRCFileProvider : PhysicalFileProvider, IGRCFileProvider {
        protected string WebRootPath { get; }

        public GRCFileProvider(IWebHostEnvironment webHostEnvironment)
        ...
        protected static void DeleteDirectoryRecursive(string path) {
