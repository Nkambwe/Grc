...
namespace Grc.ui.App.Services {
    public interface IStatutorySectionService : IGrcBaseService {
        ...
        Task<GrcResponse<GrcRequirementResponse>> GetObligationAsyncAsync(GrcIdRequest getRequest);
        ...
        Task<GrcResponse<ServiceResponse>> CreateMapAsync(ObligationMapViewModel request, long userId, string ipAddress);
    }
}
