...
namespace Grc.ui.App.Services {
    public interface IRegulatonCategoryService : IGrcBaseService {
        Task<GrcResponse<RegulatoryCategoryResponse>> GetCategoryAsync(GrcIdRequst deleteRequest);
        ...
        Task<GrcResponse<ServiceResponse>> DeleteCategoryAsync(GrcIdRequst deleteRequest);
