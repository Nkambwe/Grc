namespace Grc.ui.App.Http.Endpoints {
    ...
    public class  DepartmentEndpoints {
         public string DepartmentById { get; set; } = string.Empty;
         public string DepartmentByName { get; set; } = string.Empty;
         ...
         public string UnitById { get; set; } = string.Empty;
         public string UnitByName { get; set; } = string.Empty;
         public string AllUnits { get; set; } = string.Empty;
         public string GetUnits { get; set; } = string.Empty;
