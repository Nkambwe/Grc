...
namespace Grc.ui.App.Enums {
    ...
    public enum Activity {
        ...
        [Description("Retrieve law/regulation by ID")]
        LAW_RETRIVE= 140,
        [Description("Create law/regulation")]
        LAW_CREATE = 141,
        [Description("Update law/regulation")]
        LAW_UPDATE = 142,
        [Description("Delete law/regulation")]
        LAW_DELETE = 143,
        ...
        [Description("Retrieve compliance issue by ID")]
        COMPLIANCE_ISSUE_RETRIEVE = 153,
        [Description("Create compliance issue")]
        COMPLIANCE_ISSUE_CREATE = 154,
