...
namespace Grc.Middleware.Api.Data.Entities.Configurations {
    public class LoginAttemptEntityConfiguration {
         public static void Configure(EntityTypeBuilder<LoginAttempt> builder) {
            ...
            builder.Property(b => b.IpAddress).HasColumnName("ip_address").HasColumnType("NVARCHAR(MAX)").IsRequired();
            ...
            builder.HasOne(b => b.User).WithMany(c => c.Attempts).HasForeignKey(b => b.UserId);
         }
    }
}
