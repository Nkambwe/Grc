...
{
    public class CircularSubmissionEntityConfiguration {
        public static void Configure(EntityTypeBuilder<CircularSubmission> builder) {
            builder.ToTable("TBL_GRC_CIRCULAR_SUBMISSION");
