...
namespace Grc.Middleware.Api.Data.Entities.Configurations {
    ...
    public class ActivityLogEntityConfiguration {
        public static void Configure(EntityTypeBuilder<ActivityLog> builder) {
            ...
            builder.Property(a => a.EntityName).HasColumnName("entity_name").HasColumnType("NVARCHAR(MAX)").IsRequired();
            ...
            builder.HasOne(a => a.ActivityType).WithMany(t => t.ActivityLogs).HasForeignKey(t => t.EntityId);
