...
namespace Grc.Middleware.Api.Data.Entities.Configurations {
    public class SystemRoleEntityConfiguration { 
        ...
        public static void Configure(EntityTypeBuilder<SystemRole> builder) {
            ...
            builder.Property(r => r.RoleName).HasColumnName("Role_name").HasColumnType("NVARCHAR(MAX)").IsRequired();
            builder.Property(r => r.Description).HasColumnName("Role_description").HasColumnType("NVARCHAR(MAX)").IsRequired();
            ...
            builder.Property(r => r.CreatedBy).HasColumnName("Created_by").HasColumnType("NVARCHAR(MAX)").IsRequired();
            builder.Property(r => r.LastModifiedOn).HasColumnName("Modified_on").IsRequired(false);
            builder.Property(r => r.LastModifiedBy).HasColumnName("Modified_by").HasColumnType("NVARCHAR(MAX)").IsRequired(false);
