    ...
    public class MappingProfile : Profile {
        ...
        public MappingProfile() {
            ...
            CreateMap<RegistrationRequest, SystemUser>()
                ...
                .ForMember(us => us.MiddleName, reg => reg.MapFrom(o => (o.MiddleName ?? string.Empty).Trim()))
            ...
            CreateMap<SystemUser, AuthenticationResponse>()
                ...
                .ForMember(a => a.MiddleName, reg => reg.MapFrom(o => (o.MiddleName ?? string.Empty).Trim()))
                ...
                //.ForMember(a => a.LockOn, reg => reg.MapFrom(o => o.LockOn))
                //.ForMember(a => a.IsLocked, reg => reg.MapFrom(o => o.IsLocked))
                //.ForMember(a => a.FailedAttempts, reg => reg.MapFrom(o => o.FailedAttempts))
            ...
            CreateMap<AuditTaskRequest, AuditTask>()
                ...
                .ForMember(r => r.SendReminder, reg => reg.MapFrom(o => o.SendReminder))
                .ForMember(r => r.Interval, reg => reg.MapFrom(o => (o.Interval ?? string.Empty).Trim()))
            ...
            CreateMap<PolicyDocumentRequest, RegulatoryDocument>()
                ...
                .ForMember(r => r.Approver, reg => reg.MapFrom(o => (o.Approver ?? string.Empty).Trim()))
                .ForMember(r => r.ApprovalDate, reg => reg.MapFrom(o => o.ApprovalDate))
                .ForMember(r => r.PolicyAligned, reg => reg.MapFrom(o => o.IsAligned))
                .ForMember(r => r.NeedBoardApproval, reg => reg.MapFrom(o => o.NeedBoardApproval))
                .ForMember(r => r.NeedMcrApproval, reg => reg.MapFrom(o => o.NeedMcrApproval))
                .ForMember(r => r.OnIntranet, reg => reg.MapFrom(o => o.OnIntranet))
                .ForMember(r => r.IsApproved, reg => reg.MapFrom(o => o.IsApproved))
                ...
                .ForMember(r => r.Interval, reg => reg.MapFrom(o => (o.Interval ?? string.Empty).Trim()))
                .ForMember(r => r.IntervalType, reg => reg.MapFrom(o => (o.IntervalType ?? string.Empty).Trim()))
                .ForMember(r => r.SentMessages, reg => reg.MapFrom(o => o.SentMessages))
                .ForMember(r => r.IsLocked, reg => reg.MapFrom(o => o.IsLocked))
                .ForMember(r => r.ReminderMessage, reg => reg.MapFrom(o => o.ReminderMessage))
                .ForMember(r => r.CreatedBy, reg => reg.MapFrom(o => (o.CreatedBy ?? string.Empty).Trim()))
                .ForMember(r => r.IsDeleted, reg => reg.MapFrom(o => o.IsDeleted))
                .ForMember(r => r.CreatedOn, reg => reg.MapFrom(o => o.CreatedOn))
                .ForMember(r => r.LastModifiedBy, reg => reg.MapFrom(o => o.ModifiedBy))
            ...
            CreateMap<ProcessRequest, OperationProcess>()
                ...
                .ForMember(p => p.ResponsibilityId, reg => reg.MapFrom(o => o.ResponsibilityId))
                .ForMember(p => p.OwnerId, reg => reg.MapFrom(o => o.OwnerId))
            ...
            CreateMap<SystemUser, UserResponse>()
               ...
               .ForMember(u => u.MiddleName, reg => reg.MapFrom(o => (o.MiddleName ?? string.Empty).Trim()))
               ...
               .ForMember(u =>u.IsApproved, reg => reg.MapFrom(o => o.IsApproved ?? false))
               .ForMember(u =>u.IsVerified, reg => reg.MapFrom(o => o.IsVerified ?? false))
               ...
               .ForMember(u => u.LastLogindate, reg => reg.MapFrom(o => o.LastLoginDate))
            ...
            CreateMap<ProcessApprovalRequest, ProcessApproval>()
                ...
                .ForMember(a => a.ManagerialStart, reg => reg.MapFrom(o => o.MgrStart))
                .ForMember(a => a.ManagerialEnd, reg => reg.MapFrom(o => o.MgrEnd))
                .ForMember(a => a.ManagerialStatus, reg => reg.MapFrom(o => o.MgrStatus))
                .ForMember(a => a.ManagerialComment, reg => reg.MapFrom(o => o.MgrComment))
