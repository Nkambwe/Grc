namespace Grc.Middleware.Api.Defaults {
    ...
    public class ActivityTypeDefaults {
        ...
        #region Department Activities
        public const string DEPARTMENT_ADDED = "Department.Added";
        public const string DEPARTMENT_EDITED = "Department.Edited";
        public const string DEPARTMENT_DELETED = "Department.Deleted";
        public const string DEPARTMENT_UNIT_ADDED = "Department.Unit.Added";
        public const string DEPARTMENT_UNIT_EDITED = "Department.Unit.Edited";
        public const string DEPARTMENT_UNIT_DELETED = "Department.Unit.Deleted";
        public const string DEPARTMENT_HEAD_ADDED = "Department.Head.Added";
        public const string DEPARTMENT_HEAD_EDITED = "Department.Head.Edited";
        public const string DEPARTMENT_HEAD_DELETED = "Department.SeHead.Deleted";
        public const string DEPARTMENT_UNIT_HEAD_ADDED = "Department.Unit.Head.Added";
        public const string DEPARTMENT_UNIT_HEAD_EDITED = "Department.Unit.Head.Edited";
        public const string DEPARTMENT_UNIT_HEAD_DELETED = "Department.Unit.Head.Deleted";
