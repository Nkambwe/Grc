    ...
    public class OperationProcessService : BaseService, IOperationProcessService
    {
        ...
        public bool Update(ProcessRequest request, bool includeDeleted = false)
        {
            ...
            try
            {
                ...
                if (process != null)
                {
                    ...
                    process.FilePath = (request.FilePath ?? string.Empty).Trim();
                    ...
                    process.ReasonOnhold = (request.ReasonOnhold ?? string.Empty).Trim();
        ...
        public bool Delete(IdRequest request)
        {
            ...
            try
            {
                ...
                if (process != null)
                {
                    ...
                    _ = uow.OperationProcessRepository.Delete(process, request.IsDeleted);
        ...
        public async Task<bool> DeleteAsync(IdRequest request)
        {
            ...
            try
            {
                ...
                {
                    //..mark as delete this OperationProcess
                    _ = await uow.OperationProcessRepository.DeleteAsync(responsebilitytask, request.IsDeleted);
