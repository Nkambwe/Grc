    ...
    public class AuditTaskService : BaseService, IAuditTaskService
    {
        ...
        public bool Update(AuditTaskRequest request, bool includeDeleted = false)
        {
            ...
            try
            {
                ...
                if (auditTask != null)
                {
                    ...
                    //..check entity state
                    _ = uow.AuditTaskRepository.Update(auditTask);
                    var entityState = ((UnitOfWork)uow).Context.Entry(auditTask).State;
        ...
        public async Task<bool> UpdateAsync(AuditTaskRequest request, bool includeDeleted = false)
        {
            ...
            try
            {
                ...
                if (auditTask != null)
                {
                    ...
                    //..check entity state
                    _ = await uow.AuditTaskRepository.UpdateAsync(auditTask);
                    var entityState = ((UnitOfWork)uow).Context.Entry(auditTask).State;
                    Logger.LogActivity($"Audit task state after Update: {entityState}", "DEBUG");
        ...
        public bool Delete(IdRequest request, bool markAsDeleted = false)
        {
            ...
            try
            {
                ...
                if (auditTask != null)
                {
                    ...
                    _ = uow.AuditTaskRepository.Delete(auditTask, request.IsDeleted);
        ...
        public async Task<bool> DeleteAsync(IdRequest request, bool markAsDeleted = false)
        {
            ...
            try
            {
                ...
                {
                    //..mark as delete this audit task
                    _ = await uow.AuditTaskRepository.DeleteAsync(tasktask, request.IsDeleted);
